 ...
 */
public class ConstantReceptionBehaviour extends Behaviour {
    private ConstantEvaluateBehaviour evaluateBehaviour;
    ...
    public void action() {
        listen(myAgent, this, MessageTemplate.MatchPerformative(ACLMessage.REQUEST)).forRequest(equationMessage -> {
            ...
            if (evaluateBehaviour == null) {
                evaluateBehaviour = new ConstantEvaluateBehaviour();
